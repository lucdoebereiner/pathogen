	...
	return _Utils_Tuple2(
		{
			...
			antiBodies: _List_Nil,
			micLevel: $elm$core$Maybe$Nothing,
			pathogens: _List_Nil,
			recordingTime: 0.0,
			render: true,
			size: {height: 900, width: 1440},
			view: $author$project$Main$Welcome
		},
		A2($elm$core$Task$perform, $author$project$Main$GotViewport, $elm$browser$Browser$Dom$getViewport));
};
var $author$project$Main$AllowRecording = function (a) {
	return {$: 'AllowRecording', a: a};
};
var $author$project$Main$ReceivedInfo = function (a) {
	return {$: 'ReceivedInfo', a: a};
};
var $author$project$Main$ReceivedMicLevel = function (a) {
	return {$: 'ReceivedMicLevel', a: a};
};
var $author$project$Main$ReceivedRecordingTime = function (a) {
	return {$: 'ReceivedRecordingTime', a: a};
};
var $author$project$Main$Resize = function (a) {
	return {$: 'Resize', a: a};
};
var $author$project$Main$SetStarted = function (a) {
	return {$: 'SetStarted', a: a};
};
var $author$project$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Main$allowRecording = _Platform_incomingPort('allowRecording', $elm$json$Json$Decode$bool);
...
var $author$project$Main$receiveMicLevel = _Platform_incomingPort('receiveMicLevel', $elm$json$Json$Decode$float);
var $author$project$Main$receiveRecordingTime = _Platform_incomingPort('receiveRecordingTime', $elm$json$Json$Decode$float);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$receiveState = _Platform_incomingPort('receiveState', $elm$json$Json$Decode$value);
var $author$project$Main$started = _Platform_incomingPort('started', $elm$json$Json$Decode$bool);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$receiveState($author$project$Main$ReceivedInfo),
				$author$project$Main$receiveMicLevel($author$project$Main$ReceivedMicLevel),
				$author$project$Main$receiveRecordingTime($author$project$Main$ReceivedRecordingTime),
				$author$project$Main$allowRecording($author$project$Main$AllowRecording),
				$author$project$Main$started($author$project$Main$SetStarted),
...
var $author$project$Main$AntiBodies = {$: 'AntiBodies'};
var $author$project$Main$MicInput = {$: 'MicInput'};
var $author$project$Main$Recording = {$: 'Recording'};
var $author$project$Main$AntiBody = F5(
	function (posX, posZ, level, state, id) {
		return {id: id, level: level, posX: posX, posZ: posZ, state: state};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Main$Matching = function (a) {
	return {$: 'Matching', a: a};
};
var $author$project$Main$Memory = function (a) {
	return {$: 'Memory', a: a};
};
var $author$project$Main$Plasma = {$: 'Plasma'};
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Main$antiBodyTypeDecoderAux = function (state) {
	switch (state) {
		case 'plasma':
			return $elm$json$Json$Decode$succeed($author$project$Main$Plasma);
		case 'matching':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$Main$Matching,
				A2($elm$json$Json$Decode$field, 'pathogen', $elm$json$Json$Decode$int));
		case 'memory':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$Main$Memory,
				A2($elm$json$Json$Decode$field, 'pathogen', $elm$json$Json$Decode$int));
		default:
			return $elm$json$Json$Decode$fail('Trying to decode state, but  ' + (state + ' is not supported.'));
	}
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$antiBodyTypeDecoder = A2(
	$elm$json$Json$Decode$andThen,
	$author$project$Main$antiBodyTypeDecoderAux,
	A2($elm$json$Json$Decode$field, 'state', $elm$json$Json$Decode$string));
var $author$project$Main$initLevel = function (f) {
	return {current: 0.0, target: f};
};
...
var $author$project$Main$antiBodyDecoder = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'state',
		$author$project$Main$antiBodyTypeDecoder,
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'level',
				...
				A3(
					...
					$elm$json$Json$Decode$succeed(
						F3(
							function (x, y, l) {
								return A3(
									$author$project$Main$AntiBody,
									x,
									y,
									$author$project$Main$initLevel(l));
							})))))));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$Pathogen = function (id) {
	return {id: id};
};
var $author$project$Main$pathogenDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'id',
	$elm$json$Json$Decode$int,
	$elm$json$Json$Decode$succeed($author$project$Main$Pathogen));
var $author$project$Main$decodeInfo = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'antiBodies',
	$elm$json$Json$Decode$list($author$project$Main$antiBodyDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'pathogens',
		$elm$json$Json$Decode$list($author$project$Main$pathogenDecoder),
		$elm$json$Json$Decode$succeed(
			F2(
				function (p, a) {
					return {antiBodies: a, pathogens: p};
				}))));
...
var $author$project$Main$openMic = _Platform_outgoingPort(
	'openMic',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$record = _Platform_outgoingPort(
	'record',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $elm$core$Basics$round = _Basics_round;
var $author$project$Main$start = _Platform_outgoingPort(
	'start',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
...
var $author$project$Main$tickLevel = function (l) {
	return _Utils_eq(l.current, l.target) ? l : (($elm$core$Basics$abs(l.current - l.target) < 0.05) ? _Utils_update(
		l,
		{current: l.target}) : _Utils_update(
		l,
		{current: (l.current * 0.95) + (l.target * 0.05)}));
};
...
var $author$project$Main$setTargetLevel = F2(
	function (target, l) {
		return _Utils_update(
			l,
			{target: target});
	});
var $author$project$Main$updateAntiBodies = F3(
	function (oldabs, abs, result) {
		updateAntiBodies:
		while (true) {
			if (!abs.b) {
				return result;
				...
				var toAdd = function () {
					var _v1 = A2(
						...
						function (antib) {
							return _Utils_eq(antib.id, newAb.id);
						},
						oldabs);
					if (_v1.$ === 'Just') {
						var oldAb = _v1.a;
						return _Utils_update(
							oldAb,
							{
								level: A2($author$project$Main$setTargetLevel, newAb.level.target, oldAb.level)
							});
					} else {
						return newAb;
					}
				}();
				var $temp$oldabs = oldabs,
					$temp$abs = rest,
					$temp$result = A2($elm$core$List$cons, toAdd, result);
				oldabs = $temp$oldabs;
				abs = $temp$abs;
				result = $temp$result;
				continue updateAntiBodies;
			}
		}
	});
		...
		switch (msg.$) {
			case 'Start':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{view: $author$project$Main$AntiBodies}),
					$author$project$Main$start(_Utils_Tuple0));
			case 'SetStarted':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{allowRecording: false, micLevel: $elm$core$Maybe$Nothing, recordingTime: 0.0, view: $author$project$Main$AntiBodies}),
			...
			case 'OpenMic':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{view: $author$project$Main$MicInput}),
					$author$project$Main$openMic(_Utils_Tuple0));
			case 'StartRecording':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{view: $author$project$Main$Recording}),
					$author$project$Main$record(_Utils_Tuple0));
			case 'ReceivedMicLevel':
				var l = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							micLevel: $elm$core$Maybe$Just(l)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReceivedRecordingTime':
				var t = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ReceivedInfo':
				var v = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeInfo, v);
				if (_v1.$ === 'Ok') {
					var i = _v1.a;
					var newAbs = A3($author$project$Main$updateAntiBodies, model.antiBodies, i.antiBodies, _List_Nil);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{antiBodies: newAbs, pathogens: i.pathogens}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = _v1;
			...
			case 'Tick':
				return model.render ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							antiBodies: A2(
								...
								function (a) {
									return _Utils_update(
										a,
										{
											level: $author$project$Main$tickLevel(a.level)
										});
								},
								model.antiBodies),
							render: false
...
var $author$project$Main$inlineCircle = F2(
	function (strokeC, fillC) {
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm_community$typed_svg$TypedSvg$Types$Px(40)),
						A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, 1, 1)
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$mdToEl = function (md) {
	var _v0 = A2($author$project$Main$render, $dillonkearns$elm_markdown$Markdown$Renderer$defaultHtmlRenderer, md);
	if (_v0.$ === 'Ok') {
		var htmls = _v0.a;
		return A2(
			...
			A2($elm$core$List$map, $mdgriffith$elm_ui$Element$html, htmls));
	} else {
		var prob = _v0.a;
...
var $author$project$Main$OpenMic = {$: 'OpenMic'};
...
var $author$project$Main$recButton = A2(
	...
	{
		label: $mdgriffith$elm_ui$Element$text('Record Pathogen'),
		onPress: $elm$core$Maybe$Just($author$project$Main$OpenMic)
	});
...
var $author$project$Main$startRecButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Border$width(1),
	...
	{
		label: $mdgriffith$elm_ui$Element$text('Record 3 seconds'),
		onPress: $elm$core$Maybe$Just($author$project$Main$StartRecording)
	});
var $mdgriffith$elm_ui$Element$Font$typeface = $mdgriffith$elm_ui$Internal$Model$Typeface;
var $author$project$Main$viewMicLevel = function (l) {
	if (l.$ === 'Nothing') {
		return A2(
			...
			$mdgriffith$elm_ui$Element$text('No input'));
	} else {
		var level = l.a;
		var db = $elm$core$Basics$round(level * 10) / 10.0;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text(
				'Input level: ' + ($elm$core$String$fromFloat(db) + 'dB')));
	}
};
...
var $author$project$Main$colorToEl = F2(
	function (c, a) {
		var rgbaColor = $avh4$elm_color$Color$toRgba(c);
		return A4($mdgriffith$elm_ui$Element$rgba, rgbaColor.red, rgbaColor.green, rgbaColor.blue, a);
	});
...
var $author$project$Main$pickColor = function (id) {
	var _v0 = A2($elm$core$Basics$modBy, 4, id);
	switch (_v0) {
		case 0:
			return A3($avh4$elm_color$Color$rgb255, 255, 0, 0);
		case 1:
			return A3($avh4$elm_color$Color$rgb255, 255, 62, 0);
		case 2:
			return A3($avh4$elm_color$Color$rgb255, 255, 124, 0);
		case 3:
			return A3($avh4$elm_color$Color$rgb255, 255, 193, 0);
		default:
			return $avh4$elm_color$Color$black;
	}
};
var $author$project$Main$viewPathogen = F2(
	function (abs, p) {
		var memory = A2(
			$elm$core$List$any,
			function (a) {
		...
		var matching = A2(
			...
			abs);
		var stateString = memory ? A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$Font$bold]),
			$mdgriffith$elm_ui$Element$text('Memory cell')) : (matching ? A2(
			$mdgriffith$elm_ui$Element$el,
			_List_Nil,
			$mdgriffith$elm_ui$Element$text('Ongoing adaptation')) : $mdgriffith$elm_ui$Element$none);
		return ((!memory) && (!matching)) ? $mdgriffith$elm_ui$Element$none : A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					A2(
						$author$project$Main$colorToEl,
						$author$project$Main$pickColor(p.id),
						0.8)),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					$mdgriffith$elm_ui$Element$centerX,
					$mdgriffith$elm_ui$Element$Border$solid,
...
var $author$project$Main$viewPathogens = function (model) {
	return ($elm$core$List$length(model.pathogens) > 0) ? A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerX]),
				$mdgriffith$elm_ui$Element$text('Current pathogens:')),
			A2(
				$elm$core$List$map,
				$author$project$Main$viewPathogen(model.antiBodies),
				model.pathogens))) : $mdgriffith$elm_ui$Element$none;
};
var $author$project$Main$linlin = F5(
	function (x, inMin, inMax, outMin, outMax) {
		return (_Utils_cmp(x, inMin) < 1) ? outMin : ((_Utils_cmp(x, inMax) > -1) ? outMax : ((((x - inMin) / (inMax - inMin)) * (outMax - outMin)) + outMin));
	});
var $author$project$Main$mapX = function (p) {
	return A5($author$project$Main$linlin, p, -15.5, 15.5, 0.0, 1.0);
};
var $author$project$Main$mapZ = function (p) {
	return A5($author$project$Main$linlin, p, -15.5, 15.5, 1.0, 0.0);
};
var $author$project$Main$pathogenId = function (ab) {
	var _v0 = ab.state;
	switch (_v0.$) {
		case 'Memory':
			var p = _v0.a;
...
var $author$project$Main$drawMatching = function (ab) {
	var radius = A5($author$project$Main$linlin, ab.level.current, 0.0, 2.0, 0.0, 0.03);
	return A2(
		$elm_community$typed_svg$TypedSvg$circle,
		_List_fromArray(
			[
				...
				$elm_community$typed_svg$TypedSvg$Types$Px(
					$author$project$Main$mapX(ab.posX))),
				$elm_community$typed_svg$TypedSvg$Attributes$cy(
				$elm_community$typed_svg$TypedSvg$Types$Px(
					$author$project$Main$mapZ(ab.posZ))),
				$elm_community$typed_svg$TypedSvg$Attributes$r(
				$elm_community$typed_svg$TypedSvg$Types$Px(radius)),
				$elm_community$typed_svg$TypedSvg$Attributes$stroke(
				$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$gray)),
				$elm_community$typed_svg$TypedSvg$Attributes$strokeWidth(
				$elm_community$typed_svg$TypedSvg$Types$Px(0.005)),
				$elm_community$typed_svg$TypedSvg$Attributes$fill(
				$elm_community$typed_svg$TypedSvg$Types$Paint(
					$author$project$Main$pickColor(
						$author$project$Main$pathogenId(ab))))
			]),
		_List_Nil);
};
var $author$project$Main$drawMemory = function (ab) {
	var radius = A5($author$project$Main$linlin, ab.level.current, 0.0, 2.0, 0.01, 0.03);
	return A2(
		$elm_community$typed_svg$TypedSvg$circle,
		_List_fromArray(
			[
...
var $author$project$Main$drawPlasma = function (ab) {
	var radius = A5($author$project$Main$linlin, ab.level.current, 0.0, 2.0, 0.0, 0.02);
	return A2(
		$elm_community$typed_svg$TypedSvg$circle,
		_List_fromArray(
			[
...
var $author$project$Main$visualization = F2(
	function (drawingSize, model) {
		var abCircles = A2(
			$elm$core$List$map,
			function (ab) {
				var _v0 = ab.state;
				switch (_v0.$) {
					case 'Plasma':
						return $author$project$Main$drawPlasma(ab);
					case 'Matching':
						return $author$project$Main$drawMatching(ab);
					default:
						return $author$project$Main$drawMemory(ab);
				}
			},
			model.antiBodies);
		return A2(
			...
			_List_fromArray(
				[
					$elm_community$typed_svg$TypedSvg$Attributes$width(
					$elm_community$typed_svg$TypedSvg$Types$Px(drawingSize.width)),
					$elm_community$typed_svg$TypedSvg$Attributes$height(
					$elm_community$typed_svg$TypedSvg$Types$Px(drawingSize.height)),
					A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, 1, 1)
				]),
			abCircles);
	});
var $author$project$Main$view = function (model) {
	var drawingSize = {
		height: $elm$core$Basics$round(model.size.height * 0.75),
		width: $elm$core$Basics$round(model.size.width * 0.9)
	};
	return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('PATHOGEN'))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('by Luc Döbereiner (2021)')
								]))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Main$mdToEl($author$project$Text$description1),
												A2(
												$mdgriffith$elm_ui$Element$row,
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														...
														A2($author$project$Main$inlineCircle, $avh4$elm_color$Color$darkGrey, $avh4$elm_color$Color$darkGrey)),
														A2(
														$mdgriffith$elm_ui$Element$paragraph,
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																$mdgriffith$elm_ui$Element$text('Random plasma cells that may be used as a basis for a clonal mutation process.')
															]))
													])),
												A2(
												$mdgriffith$elm_ui$Element$row,
												...
												_List_fromArray(
													[
														...
														A2($author$project$Main$inlineCircle, $avh4$elm_color$Color$gray, $avh4$elm_color$Color$red)),
														A2(
														$mdgriffith$elm_ui$Element$paragraph,
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																$mdgriffith$elm_ui$Element$text('Iteratively produced clones that are compared to a specific pathogen that the system tries to adapt to.')
															]))
													])),
												A2(
												$mdgriffith$elm_ui$Element$row,
												...
												_List_fromArray(
													[
														...
														A2($author$project$Main$inlineCircle, $avh4$elm_color$Color$black, $avh4$elm_color$Color$red)),
														A2(
														$mdgriffith$elm_ui$Element$paragraph,
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																$mdgriffith$elm_ui$Element$text('Memory cells that remain once the adaptation has been completed.')
															]))
													])),
												$author$project$Main$mdToEl($author$project$Text$description3)
											]))
									]);
							case 'MicInput':
								return _List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Main$viewMicLevel(model.micLevel),
												model.allowRecording ? A2(
												$mdgriffith$elm_ui$Element$el,
												_List_fromArray(
													[$mdgriffith$elm_ui$Element$centerX]),
												$author$project$Main$startRecButton) : $mdgriffith$elm_ui$Element$none
											]))
									]);
							case 'Recording':
								return _List_fromArray(
											...
											[
												...
												$mdgriffith$elm_ui$Element$text(
													$elm$core$String$fromInt(
														$elm$core$Basics$round(3.0 - model.recordingTime)) + ' second(s) remaining'))
											]))
									]);
							default:
								return _List_fromArray(
									[
										...
										_List_fromArray(
											[
												($elm$core$List$length(model.pathogens) < 4) ? A2(
												$mdgriffith$elm_ui$Element$el,
												_List_fromArray(
													[$mdgriffith$elm_ui$Element$centerX]),
												$author$project$Main$recButton) : $mdgriffith$elm_ui$Element$none,
												$author$project$Main$viewPathogens(model),
												A2(
												$mdgriffith$elm_ui$Element$el,
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$width(
														$mdgriffith$elm_ui$Element$px(drawingSize.width)),
														$mdgriffith$elm_ui$Element$centerX
													]),
												$mdgriffith$elm_ui$Element$html(
													A2($author$project$Main$visualization, drawingSize, model)))
											]))
									]);
						}
					}())
